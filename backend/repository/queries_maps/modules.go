...
func (m *Module) SaveModule(pool *pgxpool.Pool) (string, error) {
	...
	err = conn.QueryRow(context.Background(),
		"INSERT INTO modules (map_id, habitation_type, module_type, module_points_json) VALUES ($1, $2, $3, $4) RETURNING id",
